    ...
    <div className="relative">
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white text-black p-8 text-center shadow-2xl rounded-2xl max-w-2xl">
        ...
        <p className="text-lg bg-white">
          This demo is currently unavailable while I'm migrating the site to
          SST.
        </p>
      </div>
      ...
      <div className="m-10 pointer-events-none">
        ...
        <p className="text-lg pb-5">
          ...
          Implements
          <Link
            className="cool-link px-2"
            target="_blank"
            href="https://en.wikipedia.org/wiki/Item-item_collaborative_filtering"
          >
          ...
          <Link
            className="cool-link px-2"
            target="_blank"
            href="https://grouplens.org/datasets/movielens/1m/"
          >
          ...
          <Link
            className="cool-link px-2"
            target="_blank"
            href="https://github.com/jcrowe6/movie-recommender-api"
          >
            here
          </Link>
        </p>
        ...
        <hr className="my-8" />
        <button
          className="text-3xl mb-8 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"
